...
public class Advance_Display_ScenFour extends AppCompatActivity {
    ...
    private void patienOneRandomGraphs() {
        ...
        seriesPAO.appendData(new DataPoint(7, 97), true, 15);
        seriesPAO.appendData(new DataPoint(8, 97), true, 15);
        seriesPAO.appendData(new DataPoint(9, 95), true, 15);
        ...
        seriesTemp.appendData(new DataPoint(3, 98.7), true, 15);
    ...
    private void patienTwoRandomGraphs() {
        ...
        seriesBP.appendData(new DataPoint(3, 144), true, 15);
        seriesBP.appendData(new DataPoint(4, 139), true, 15);
        seriesBP.appendData(new DataPoint(5, 139), true, 15);
        seriesBP.appendData(new DataPoint(6, 139), true, 15);
        seriesBP.appendData(new DataPoint(7, 135), true, 15);
        seriesBP.appendData(new DataPoint(8, 132), true, 15);
        seriesBP.appendData(new DataPoint(9, 124), true, 15);
        seriesBP.appendData(new DataPoint(10, 120), true, 15);
        seriesBP.appendData(new DataPoint(11, 141), true, 15);
        seriesBP.appendData(new DataPoint(12, 142), true, 15);
        seriesBP.appendData(new DataPoint(13, 140), true, 15);
        seriesBP.appendData(new DataPoint(14, 140), true, 15);
        seriesBP.appendData(new DataPoint(15, 142), true, 15);

        seriesPulse.appendData(new DataPoint(1, 124), true, 15);
        ...
        seriesRR.appendData(new DataPoint(1, 24), true, 15);
        seriesRR.appendData(new DataPoint(2, 23), true, 15);
        seriesRR.appendData(new DataPoint(3, 20), true, 15);
        seriesRR.appendData(new DataPoint(4, 22), true, 15);
        seriesRR.appendData(new DataPoint(5, 23), true, 15);
        seriesRR.appendData(new DataPoint(6, 21), true, 15);
        seriesRR.appendData(new DataPoint(7, 19), true, 15);
        seriesRR.appendData(new DataPoint(8, 15), true, 15);
        seriesRR.appendData(new DataPoint(9, 15), true, 15);
        seriesRR.appendData(new DataPoint(10, 17), true, 15);
        seriesRR.appendData(new DataPoint(11, 18), true, 15);
        ...
        seriesRR.appendData(new DataPoint(15, 16), true, 15);
        ...
        seriesTemp.appendData(new DataPoint(2, 98.4), true, 15);
        seriesTemp.appendData(new DataPoint(3, 98.6), true, 15);
        seriesTemp.appendData(new DataPoint(4, 98.5), true, 15);
        seriesTemp.appendData(new DataPoint(5, 98.7), true, 15);
        seriesTemp.appendData(new DataPoint(6, 98.6), true, 15);
        seriesTemp.appendData(new DataPoint(7, 98.7), true, 15);
        seriesTemp.appendData(new DataPoint(8, 98.7), true, 15);
        ...
        seriesTemp.appendData(new DataPoint(14, 98.6), true, 15);
        seriesTemp.appendData(new DataPoint(15, 98.8), true, 15);
    }

    private void patienThreeRandomGraphs() {
        seriesBP.appendData(new DataPoint(1, 143), true, 15);
        seriesBP.appendData(new DataPoint(2, 147), true, 15);
        ...
        seriesBP.appendData(new DataPoint(8, 122), true, 15);
        seriesBP.appendData(new DataPoint(9, 121), true, 15);
        seriesBP.appendData(new DataPoint(10, 124), true, 15);
        seriesBP.appendData(new DataPoint(11, 122), true, 15);
        seriesBP.appendData(new DataPoint(12, 125), true, 15);
        seriesBP.appendData(new DataPoint(13, 123), true, 15);
        seriesBP.appendData(new DataPoint(14, 124), true, 15);
        seriesBP.appendData(new DataPoint(15, 125), true, 15);

        seriesPulse.appendData(new DataPoint(1, 124), true, 15);
        seriesPulse.appendData(new DataPoint(2, 122), true, 15);
        seriesPulse.appendData(new DataPoint(3, 121), true, 15);
        seriesPulse.appendData(new DataPoint(4, 121), true, 15);
        seriesPulse.appendData(new DataPoint(5, 119), true, 15);
        seriesPulse.appendData(new DataPoint(6, 114), true, 15);
        seriesPulse.appendData(new DataPoint(7, 107), true, 15);
        seriesPulse.appendData(new DataPoint(8, 103), true, 15);
        seriesPulse.appendData(new DataPoint(9, 99), true, 15);
        seriesPulse.appendData(new DataPoint(10, 98), true, 15);
        seriesPulse.appendData(new DataPoint(11, 96), true, 15);
        seriesPulse.appendData(new DataPoint(12, 90), true, 15);
        seriesPulse.appendData(new DataPoint(13, 89), true, 15);
        seriesPulse.appendData(new DataPoint(14, 86), true, 15);
        seriesPulse.appendData(new DataPoint(15, 87), true, 15);
        ...
        seriesRR.appendData(new DataPoint(4, 24), true, 15);
        seriesRR.appendData(new DataPoint(5, 23), true, 15);
        seriesRR.appendData(new DataPoint(6, 22), true, 15);
        seriesRR.appendData(new DataPoint(7, 21), true, 15);
        seriesRR.appendData(new DataPoint(8, 19), true, 15);
        seriesRR.appendData(new DataPoint(9, 16), true, 15);
        seriesRR.appendData(new DataPoint(10, 17), true, 15);
        seriesRR.appendData(new DataPoint(11, 15), true, 15);
        seriesRR.appendData(new DataPoint(12, 14), true, 15);
        seriesRR.appendData(new DataPoint(13, 15), true, 15);
        seriesRR.appendData(new DataPoint(14, 13), true, 15);
        seriesRR.appendData(new DataPoint(15, 16), true, 15);

        seriesPAO.appendData(new DataPoint(1, 92), true, 15);
        seriesPAO.appendData(new DataPoint(2, 93), true, 15);
        seriesPAO.appendData(new DataPoint(3, 94), true, 15);
        seriesPAO.appendData(new DataPoint(4, 96), true, 15);
        seriesPAO.appendData(new DataPoint(5, 95), true, 15);
        seriesPAO.appendData(new DataPoint(6, 96), true, 15);
        seriesPAO.appendData(new DataPoint(7, 98), true, 15);
        seriesPAO.appendData(new DataPoint(8, 97), true, 15);
        seriesPAO.appendData(new DataPoint(9, 94), true, 15);
        seriesPAO.appendData(new DataPoint(10, 96), true, 15);
        seriesPAO.appendData(new DataPoint(11, 94), true, 15);
        seriesPAO.appendData(new DataPoint(12, 95), true, 15);
        seriesPAO.appendData(new DataPoint(13, 97), true, 15);
        seriesPAO.appendData(new DataPoint(14, 95), true, 15);
        seriesPAO.appendData(new DataPoint(15, 94), true, 15);
        ...
        seriesTemp.appendData(new DataPoint(7, 98.5), true, 15);
        seriesTemp.appendData(new DataPoint(8, 98.6), true, 15);
        seriesTemp.appendData(new DataPoint(9, 98.4), true, 15);
        seriesTemp.appendData(new DataPoint(10, 98.5), true, 15);
        seriesTemp.appendData(new DataPoint(11, 98.6), true, 15);
        seriesTemp.appendData(new DataPoint(12, 98.4), true, 15);
        seriesTemp.appendData(new DataPoint(13, 98.6), true, 15);
        seriesTemp.appendData(new DataPoint(14, 98.6), true, 15);
